                      ...
                      <div className="flex-1 flex flex-col justify-between h-full relative z-10">
                        <div className="flex justify-between border-b border-white/20 pb-3">
                          <div>
                            ...
                            <motion.div layoutId="dept-id" transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="text-sm sm:text-base font-bold tracking-widest text-red-500">Digital Architect</motion.div>
                          </div>
                        ...
                        <div className="my-auto">
                          ...
                          <motion.div layoutId="full-name" transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="text-xl sm:text-2xl tracking-[0.2em] leading-none uppercase">MOURTADA BOUIZAKRNE</motion.div>
                        </div>
              ...
              <div className="max-w-7xl mx-auto space-y-24 md:space-y-32">
                ...
                <header className="border-b border-white/20 pb-8 flex flex-col-reverse md:flex-row justify-between items-start gap-8 md:gap-12">
                  <div className="w-full md:w-2/3 flex flex-col">
                    <motion.h1 layoutId="full-name" transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="text-[clamp(2rem,5vw,3.5rem)] tracking-tighter mb-6 leading-none transition-all uppercase">
                      MOURTADA BOUIZAKRNE
                    </motion.h1>
